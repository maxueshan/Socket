...
{
    NSLog(@"1-接收到%@的消息",[[NSString alloc]initWithData:data encoding:NSUTF8StringEncoding]);
    NSLog(@"2-接收到%@的消息",[[NSString alloc]initWithData:address encoding:NSUTF8StringEncoding]);

    NSString * sendMessage = [[NSString alloc]initWithData:data encoding:NSUTF8StringEncoding];
    NSLog(@"接收到%@的消息",sendMessage);
